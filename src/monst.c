...
NEARDATA struct permonst mons[] = {
    ...
    MON("gargoyle", S_GREMLIN, LVL(6, 10, -4, 0, -9), (G_GENO | 2),
        ...
        0, CLR_BROWN),
    MON("spouted gargoyle", S_GREMLIN, LVL(7, 12, -3, 0, -11), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 6), ATTK(AT_CLAW, AD_PHYS, 3, 6),
          ATTK(AT_BREA, AD_RUST, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(100, 250, MS_GRUNT, MZ_HUMAN), MR_STONE, MR_STONE,
